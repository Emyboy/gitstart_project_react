                        ...
                        <div className="reg-form-container">
                            ...
                            <div className="reg-options">
                                <ul className="nav nav-tabs">
                                    <li className="active"><a href="#cregister" data-toggle="tab">Register</a></li>
                                    <li><a href="#clogin" data-toggle="tab">Login</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="tab-content">
                                <div className="tab-pane active" id="register">
                                    ...
                                    <p><a href="#c">Already have an account?</a></p>
                                ...
                                <div className="tab-pane" id="login">
                                    ...
                                    <p><a href="#c">Forgot Password?</a></p>
